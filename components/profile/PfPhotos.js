...
export default function PfPhotos() {
    ...
    const active = (newData, newPage, getUser, load) => {
        ...
        axios({
            ...
            method: 'post',
            url: "https://ws.tybyty.com/fotos/perfil",
            data: {
                ...
                <AlertNotificationRoot theme="dark">
                    ...
                    {(data.length > 0) && <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "center", marginTop: 5 }}>
                        ...
                        {data.map((x, index) =>
                            ...
                            <TouchableOpacity
                                key={index}
                                onPress={() => notReloadNavigate("PfDetailPhoto", { "id_usuario": x.id_usuario, "usuario": x.usuario, "foto": x.foto, "id": x.id })}
                            >
