...
export default function Videos() {
        ...
        try {
            ...
            if (getUser !== null) {
                ...
                if (restart) {
                    ...
                    active(data, page, user, (category) ? category : 0, false);
                }
    ...
    const active = (newData, newPage, getUser, newCategory, load) => {
        ...
        axios({
            ...
            method: 'post',
            url: "https://ws.tybyty.com/videos/visitantes",
            data: {
    ...
    const options = () => {
        ...
        axios({
            method: 'post',
            url: 'https://ws.tybyty.com/admin/videos/categorias',
                ...
                <AlertNotificationRoot theme="dark">
                    ...
                    <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "center", marginTop: 5 }}>
                        ...
                        {(data.length > 0) && data.map((x, index) =>
                            ...
                            <TouchableOpacity
                                key={index}
                                onPress={() => notReloadNavigate("DetailVideo", { "id_usuario": x.id_usuario, "usuario": x.usuario, "foto":x.foto, "id": x.id })}
                            >
