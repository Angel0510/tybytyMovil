import { SafeAreaView, StyleSheet, Text, View, TouchableOpacity, TextInput, Image, FlatList, Dimensions } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAwareScrollView style={{ margin: 5 }}>
        ...
        <View style={{ ...styles.login }}>
          ...
          <TouchableOpacity
            onPress={() => setBuy((buy == "EUR") ? "CDT" : "EUR")}
            style={{ ...styles.buttonContainer, marginTop: 20, backgroundColor: "#2F7147" }}
          >
          ...
          >
            <Text style={styles.buttonText}>{Language.get(language, "Pagar")}</Text>
          </TouchableOpacity>
