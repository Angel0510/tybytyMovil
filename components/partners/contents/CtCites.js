...
export default function FvCites() {
    ...
    const active = (newData, newPage, getUser, newFilters, load) => {
        ...
        axios({
            ...
            method: 'post',
            url: "https://ws.tybyty.com/citas/lista",
            data: {
    ...
    const options = () => {
        ...
        axios({
            method: 'get',
            url: 'https://ws.tybyty.com/citas/categorias',
            data: {},
            responseType: 'json',
            responseEncoding: 'utf8',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' }
            ...
            if (response.status == 200) {
                ...
                var dt = (response.data.categorias.length > 0) ? response.data.categorias : [];
        ...
        <SafeAreaView style={styles.container}>
                    ...
                    <KeyboardAwareScrollView style={modal.body}>
                        ...
                        <View style={modal.content}>
                            ...
                            <TextInput
                                ...
                                value={searchCite}
                                onChangeText={text => setSearchCite(text)}
                                style={styles.input}
                            />
            ...
            <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <TouchableOpacity
                        onPress={() => notReloadNavigate("NewCite")}
                        style={{ ...styles.buttonContainer }}
                    >
                        <AntDesign name="plus" size={24} color="white" />

                        <Text style={styles.buttonText}>{Language.get(language, "Cita")}</Text>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            ...
                            <View style={{ flex: 1.5 }}>
                                ...
                                <View style={{ flexDirection: "row", flexWrap: 'wrap', padding: 10 }}>
                                    ...
                                    <Text style={{ ...styles.text, fontSize: 13, marginLeft: 5, color: "#d63384", fontWeight: 'bold' }} onPress={() => notReloadNavigate("CtDetailCite", {"id_usuario": x.id_usuario, "usuario": x.usuario, "foto": x.foto, "id": x.id})}>

                                        <FontAwesome name="external-link" size={13} color="#d63384" /> {Language.get(language, "Ver Cita")}
                                    </Text>
