        ...
        axios({
            ...
            if (response.status == 200) {
                ...
                Dialog.show({
                    type: ALERT_TYPE.SUCCESS,
                    title: Language.get(language, 'Exito'),
                    textBody: Language.get(language, 'Video eliminado'),
                    button: Language.get(language, 'Cerrar')
                });
    ...
    return (
        <SafeAreaView style={styles.container}>
                ...
                <View>
                    ...
                    <View style={modal.title}>
                        ...
                        <Text style={{ ...styles.text, color: "white", fontSize: 17, fontWeight: "bold" }}>
                            {Language.get(language, "Eliminar Video")}
                        </Text>
                    ...
                    <KeyboardAwareScrollView style={modal.body}>
                        ...
                        <View style={modal.content}>
                            ...
                            <Text style={{ ...styles.text, color: "white", fontSize: 17 }}>{Language.get(language, "Estas seguro que deseas eliminar el video?")}</Text>
            ...
            {(video && user) && <View style={{ flexDirection: "row", flexWrap: 'wrap', alignItems: "center", padding: 10, backgroundColor: "#1A1E20" }}>
                ...
                <Text style={{ ...styles.text, marginTop: 10, marginLeft: 20, color: "#d63384", fontWeight: 'bold' }} onPress={() => notReloadNavigate("Profile", { "id_usuario": video.id_usuario, "usuario": video.usuario })}>
