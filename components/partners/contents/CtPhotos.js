...
export default function FvPhotos() {
    ...
    const active = (newData, newPage, getUser, newFilters, load) => {
        ...
        axios({
            ...
            method: 'post',
            url: "https://ws.tybyty.com/albumes/fotos/lista",
            data: {

                "id_usuario": getUser.id,
                "filters": {...newFilters,"id_usuario":getUser.id},
                "page": (load) ? newPage : 1,
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <TouchableOpacity
                        onPress={() => notReloadNavigate("NewPhoto")}
                        style={{ ...styles.buttonContainer }}
                    >
                        <AntDesign name="plus" size={24} color="white" />

                        <Text style={styles.buttonText}>{Language.get(language, "Foto")}</Text>
                ...
                <AlertNotificationRoot theme="dark">
                    ...
                    {(data.length > 0) && <View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "center", marginTop: 5 }}>
                        ...
                        {data.map((x, index) =>
                            ...
                            <TouchableOpacity
                                key={index}
                                onPress={() => notReloadNavigate("CtDetailPhoto", {"id_usuario": x.id_usuario, "usuario": x.usuario, "foto": x.foto, "id": x.id})}
                            >
