...
export default function FvDetailPhoto() {
        ...
        axios({
            ...
            if (response.status == 200) {
                ...
                Dialog.show({
                    ...
                    textBody: Language.get(language, 'Foto eliminada'),
                    button: Language.get(language, 'Cerrar')
                });
        ...
        <SafeAreaView style={styles.container}>
                ...
                <View>
                    ...
                    <View style={modal.title}>
                        ...
                        <Text style={{ ...styles.text, color: "white", fontSize: 17, fontWeight: "bold" }}>
                            {Language.get(language, "Eliminar Foto")}
                        </Text>
                    ...
                    <KeyboardAwareScrollView style={modal.body}>
                        ...
                        <View style={modal.content}>
                            ...
                            <Text style={{ ...styles.text, color: "white", fontSize: 17 }}>{Language.get(language, "Estas seguro que deseas eliminar la foto?")}</Text>
                    ...
                    <KeyboardAwareScrollView style={modal.body}>
                        ...
                        <View style={modal.content}>
                            ...
                            <View style={{ justifyContent: "center", alignItems: "center" }}>
                                ...
                                {(photo && user) && <Text style={{ ...styles.text, color: "white", fontSize: 24 }}>CDT {photo.precio}</Text>}
            ...
            {(images.length > 0 && photo && user) && <KeyboardAwareScrollView style={{ padding: 10, marginBottom: 10 }}>
                ...
                <AlertNotificationRoot theme="dark">
                    ...
                    <PagerView style={{ height: 330, marginTop: 20 }} ref={pagerRef} onPageSelected={handlePageSelected}>
