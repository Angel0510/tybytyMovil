...
export default function FvCites() {
    ...
    const active = (newData, newPage, getUser, newFilters, load) => {
        ...
        axios({
            ...
            method: 'post',
            url: "https://ws.tybyty.com/citas/lista/favoritos",
            data: {
    ...
    const options = () => {
        ...
        axios({
            method: 'get',
            url: 'https://ws.tybyty.com/citas/visitantes/opciones',
            data: {},
            responseType: 'json',
            responseEncoding: 'utf8',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' }
                        ...
                        <View style={{ flexDirection: "row" }}>
                            ...
                            <View style={{ flex: 1.5 }}>
                                ...
                                <View style={{ flexDirection: "row", flexWrap: 'wrap', padding: 10 }}>
                                    ...
                                    <Text style={{ ...styles.text, fontSize: 13, marginLeft: 5, color: "#d63384", fontWeight: 'bold' }} onPress={() => notReloadNavigate("FvDetailCite", {"id_usuario": x.id_usuario, "usuario": x.usuario, "foto":x.foto, "id": x.id})}>
