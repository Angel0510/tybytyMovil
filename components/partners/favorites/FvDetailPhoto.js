    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {(images.length > 0 && photo && user) && <View style={{ flexDirection: "row", flexWrap: 'wrap', alignItems: "center", padding: 10, backgroundColor: "#1A1E20" }}>
                ...
                <Text style={{ ...styles.text, marginTop: 10, marginLeft: 20, color: "#d63384", fontWeight: 'bold' }} onPress={() => notReloadNavigate("Profile",{"id_usuario": photo.id_usuario,"usuario": photo.usuario,"foto": photo.foto})}>
