...
export default function FvAds() {
    ...
    const active = (newData, newPage, getUser, newFilters, load) => {
        ...
        axios({
            ...
            method: 'post',
            url: "https://ws.tybyty.com/anuncios/lista/favoritos",
            data: {
                        ...
                        <View style={{ flexDirection: "row" }}>
                            ...
                            <View style={{ flex: 1.5 }}>
                                ...
                                <View style={{ flexDirection: "row", flexWrap: 'wrap', padding: 10 }}>
                                    ...
                                    <Text style={{ ...styles.text, fontSize: 13, marginLeft: 5, color: "#d63384", fontWeight: 'bold' }} onPress={() => notReloadNavigate("FvDetailAd", { "id_usuario": x.id_usuario, "usuario": x.usuario, "foto":x.foto, "id": x.id })}>
